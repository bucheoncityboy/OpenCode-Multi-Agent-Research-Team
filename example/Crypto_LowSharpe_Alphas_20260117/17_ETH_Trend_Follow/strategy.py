...
DATA_PATH = "C:/Users/PC/Desktop/Quant/boll/sniper/data_cache/ETHUSDT_15m_2024-01-01_2024-12-31.csv"
COST_TAKER = 0.0004
SLIPPAGE = 0.0001
FAST = 50
SLOW = 200
...
def run_strategy(df):
    ...
    df_1h['fast'] = df_1h['close'].ewm(span=FAST).mean()
    df_1h['slow'] = df_1h['close'].ewm(span=SLOW).mean()
